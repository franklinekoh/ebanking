...
<html>
    ...
    <title><?= isset($title)? $title.$this->uri->segment(2): 'untitled'?></title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-history fa-fw"></i> total history for <?= $this->uri->segment(2)?></h3>
                                <a href="<?= base_url('cpanel/customer/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4))?>">back <i class="fa fa-arrow-circle-left"></i></a>
                            </div>
