               ...
               <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"STAFF REGISTRATION>MONTH END?</h3>
                            </div>
                              <div class="panel-body">
                                  <form role="form" method="POST" action="<?= base_url('admin/monthly_deduction/'.$this->uri->segment(3))?>">
                                       <div class="form-group has-warning">
                                           <label class="control-label" for="inputSuccess">Admin ID is required </label>
                                           <input type="password" class="form-control" id="inputSuccess" name="admin_id" required="">
                            </div>
                                      <button type="submit" class="btn-danger btn  btn-block" >monthly deduction</button>
                                  </form> 
                              </div>
                          </div>
